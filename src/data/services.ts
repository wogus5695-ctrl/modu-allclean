...
export const services: CleaningService[] = [
  ...
  },
  {
    ...
    workingMethod: '실내 가구와 집기 보호를 위한 사전 점검 후, 천장 환기구 및 조명 기구의 먼지를 털어냅니다. 이어서 책상 주변과 탕비실 등 세부 공간을 닦아내고, 바닥 재질에 맞는 세척 작업을 실시하여 최종 마감합니다.',
    preCheckItems: [
  ...
  },
  {
    ...
    workingMethod: '공용 구역의 통행 흐름을 조율하고 안전 표지판을 설치한 뒤 작업을 시작합니다. 계단과 복도의 묵은 먼지는 전용 장비와 세정제로 닦아내며, 스텐 신주나 유리창 등 마감재별 특수 케어를 병행합니다.',
    preCheckItems: [
  ...
  },
  {
    ...
    neededSituations: [
      ...
      '오염수가 고여 흙탕물 앙금과 악취가 발생하기 시작할 때',
  ...
  },
  {
    ...
    neededSituations: [
      ...
      '지게차 바퀴 자국과 오일 얼룩으로 창고 바닥이 오염되었을 때',
