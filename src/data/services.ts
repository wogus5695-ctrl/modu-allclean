...
export const services: CleaningService[] = [
  ...
  {
    id: 'awning-sign',
    serviceNameKo: '어닝/간판 청소',
    serviceSlug: 'awning-signboard-cleaning',
    shortDescription: '매장의 얼굴인 어닝과 간판의 오염을 동시에 해결',
    mainDescription: '외부 노출로 인해 쉽게 더러워지는 어닝의 곰팡이와 간판의 미세먼지를 전용 약품으로 세척하여 매장의 가독성과 첫인상을 완벽하게 회복합니다.',
    neededSituations: [
      '어닝에 검은 곰팡이나 이끼가 핀 경우',
      '간판 글자가 먼지로 인해 어둡게 보일 때',
      '매장 오픈 전 외부 시설물의 일괄 세척이 필요할 때',
      '비 온 뒤 간판 아래로 검은 물줄기 자국이 생길 때'
    ],
    workingMethod: '원단 손상을 최소화하는 약품 살포 후 브러시 수작업과 고압 세척을 병행합니다. 간판은 재질에 맞춰 정밀 세척하며, 고층의 경우 장비를 활용해 안전하게 시공합니다.',
    preCheckItems: [
      '어닝 및 간판 작동/고정 상태 확인',
    ...
    targetBuildings: ['카페/음식점', '일반 상가 매장', '프랜차이즈 점포', '주유소/전시장'],
    commonProblems: ['검은 곰팡이', '거미줄/벌레', '매연 자국', '가시성 저하'],
    process: ['상담 및 진단', '전기 안전 점검', '약품 살포 및 정밀 세척', '물기 제거 및 광택', '마감 검수'],
    faq: [
      ...
      { question: '스카이 차량 비용이 포함되나요?', answer: '높은 곳에 위치한 경우 장비 비용이 별도로 추가되며, 견적 시 상세히 안내해 드립니다.' }
    ],
    priority: 5,
    indexStatus: 'index',
    imageUrl: '/images/services/awning-sign.jpg',
  },
  {
    id: 'interior-completion',
    serviceNameKo: '인테리어 후/준공 청소',
    serviceSlug: 'interior-post-construction-cleaning',
    shortDescription: '공사 분진과 시멘트 가루를 완벽 제거하여 즉시 입주 가능하도록 마감',
    mainDescription: '건축 공사나 리모델링 후 발생하는 막대한 분진, 시멘트 가루, 미세 먼지를 완벽하게 제거하여 쾌적하고 안심할 수 있는 실내 환경을 조성합니다.',
    neededSituations: [
      '건물 신축 후 공사 먼지와 잔해물이 가득할 때',
      '리모델링 공사 후 미세한 톱밥 가루와 먼지가 심할 때',
      '페인트나 실리콘 냄새로 즉시 입주가 어려울 때',
      '수납장 안쪽까지 침투한 미세 분진 제거가 필요할 때'
    ],
    workingMethod: '산업용 고성능 청소기로 분진을 흡입하고, 벽면부터 천장, 바닥까지 정밀 닦기를 진행합니다. 서랍 등 가구는 분리 세척하며 시멘트 및 실리콘 자국 제거를 병행합니다.',
    preCheckItems: [
      '공사 잔여 쓰레기 처리 범위 확인',
      '수납 가구 내부 청소 범위 확정',
      '전기 및 수도 정상 공급 상태',
    ...
    targetBuildings: ['신축 아파트/빌라', '리모델링 상가/오피스', '관공서/병원', '백화점 매장'],
    commonProblems: ['시멘트 가루/분진', '톱밥 먼지', '실리콘/스티커 자국', '새집 냄새'],
    process: ['상담 및 현장 진단', '공사 쓰레기 반출', '고압 진공 분진 흡입', '정밀 세척 및 자국 제거', '항균 탈취 소독', '마감 검수'],
    faq: [
      { question: '수납장 안쪽도 닦아주나요?', answer: '네, 모든 서랍과 선반을 분리하여 보이지 않는 안쪽의 미세한 공사 분진까지 완벽하게 제거합니다.' },
      { question: '시멘트 자국이나 실리콘도 지워지나요?', answer: '전용 제거제를 사용하여 타일이나 유리에 묻은 오염을 손상 없이 깔끔하게 정리해 드립니다.' },
      { question: '작업 후 바로 짐을 넣어도 되나요?', answer: '정밀 세척과 건조, 소독이 완료된 상태이므로 작업 직후 바로 입주 및 정리가 가능합니다.' }
    ],
    priority: 6,
    indexStatus: 'index',
